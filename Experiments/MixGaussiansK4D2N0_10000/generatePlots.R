...
setwd("C:/Users/Priscilla/Dropbox/PhD/Tese/Experimentos/R/Experiments_NumModel/MixGaussiansK4D2N0_10000/measures")
...
selected <- list(
  ...
  c(3,13,16,19,20,33,46,59,73,77,80,84), #silhueta: higher is better
  c(3,10,13,16,19,20,33,46,59,73,77,80,84) #SSQ: lower is better
  )
