...
setwd("C:/Users/Priscilla/Dropbox/PhD/Tese/Experimentos/R/Experiments_NumModel/MixGaussiansK3D2N0_10000/measures")
...
selected <- list(
  ...
  c(1,13,16,27,40,53,66,75,79,80,84), #silhueta: higher is better
  c(1,10,13,16,18,27,40,53,66,75,79,80,84) #SSQ: lower is better
  )
